...
/**
 */
public class AlertDialogFragment extends DialogFragment implements DialogInterface.OnCancelListener {
    ...
    public static AlertDialogFragment newInstance(String message) {
        return AlertDialogFragment.newInstance(null, message);
    }
